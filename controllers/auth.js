    ...
    const auth = new AppleAuth(
        {
            ...
            redirect_uri:
                "https://apple-google-sign-in-anftech.herokuapp.com/callbacks/sign_in_with_apple", // does not matter here, as this is already the callback that verifies the token after the redirection
            key_id: process.env.KEY_ID
        },
        fs.readFileSync('./keys/keysigin.p8').toString,
        "text"
    );
